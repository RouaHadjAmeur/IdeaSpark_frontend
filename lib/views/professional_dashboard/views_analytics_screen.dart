...
class _ViewsAnalyticsScreenState extends State<ViewsAnalyticsScreen> {
          ...
          SizedBox(
            ...
            child: CustomPaint(
              painter: DonutChartPainter(
                followersPercent: 12.4, // Match mock
                nonFollowersPercent: 87.6,
              ),
            ),
          ),
          Column(
            children: [
              ...
              Text(
                _formatNumber(_details?.totalViews ?? 0),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              const Text('12.4%', style: TextStyle(color: Colors.white, fontSize: 14)),
            ],
          ),
          ...
          Row(
            ...
            children: [
              ...
              const Text('87.6%', style: TextStyle(color: Colors.white, fontSize: 14)),
            ],
          ),
        ],
      ),
  ...
  Widget _buildAccountsReached() {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 16.0),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          const Text('Accounts reached', style: TextStyle(color: Colors.white, fontSize: 15)),
          Column(
            crossAxisAlignment: CrossAxisAlignment.end,
            children: [
              Text(
                _formatNumber(_details?.accountsReached ?? 0),
  ...
  Widget _buildByContentType() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 24),
        _buildProgressBarRow('Reels', _details?.reelsPercentage ?? 91.4, const Color(0xFF5E35B1)),
        const SizedBox(height: 16),
        _buildProgressBarRow('Posts', _details?.postsPercentage ?? 8.6, const Color(0xFFD32F2F)),
      ],
    );
  }
      ...
      children: [
        Padding(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('By top content', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemCount: _details?.topContent.length ?? 0,
            itemBuilder: (context, index) {
              final item = _details!.topContent[index];
              return Container(
                width: 110,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              const Expanded(
                child: Text(
                  'Audience demographics are not available because fewer than 100 accounts saw your content during the selected time period.',
  ...
  Widget _buildProfileActivity() {
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Row(
                children: [
                  const Text('Profile activity', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
                  const SizedBox(width: 8),
                  Icon(Icons.info_outline, color: Colors.grey[400], size: 16),
                ],
              ),
              Column(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  Text(_formatNumber(_details?.profileVisits ?? 0), style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.bold)),
                  Text('0%', style: TextStyle(color: Colors.grey[500], fontSize: 12)),
                ],
              ),
            ],
        ...
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16.0),
          child: Text('vs Feb 25 - Mar 26', style: TextStyle(color: Colors.grey[500], fontSize: 13)),
        ),
        const SizedBox(height: 24),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16.0),
          child: Row(
            ...
            children: [
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  Text(_formatNumber(_details?.profileVisits ?? 0), style: const TextStyle(color: Colors.white, fontSize: 15)),
                  Text('0%', style: TextStyle(color: Colors.grey[500], fontSize: 12)),
                ],
              ),
            ],
          ...
          child: Row(
            ...
            children: [
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  Text(_formatNumber(_details?.externalLinkTaps ?? 0), style: const TextStyle(color: Colors.white, fontSize: 15)),
...
class DonutChartPainter extends CustomPainter {
  ...
  DonutChartPainter({required this.followersPercent, required this.nonFollowersPercent});
