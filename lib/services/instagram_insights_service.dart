...
class InstagramInsights {
  ...
  InstagramInsights({
    ...
    required this.contentShared,
  });

  factory InstagramInsights.mock() {
...
class InstagramInsightsService {
  ...
  Future<InstagramViewsDetails> fetchViewsDetails() async {
    try {
      final token = _authService.accessToken;
      if (token == null) {
        return InstagramViewsDetails.mock();
      }
  ...
  Future<InstagramInteractionsDetails> fetchInteractionsDetails() async {
    try {
      final token = _authService.accessToken;
      if (token == null) {
        return InstagramInteractionsDetails.mock();
      }
  ...
  Future<InstagramFollowersDetails> fetchFollowersDetails() async {
    try {
      final token = _authService.accessToken;
      if (token == null) {
        return InstagramFollowersDetails.mock();
      }
...
class InstagramViewsDetails {
  ...
  factory InstagramViewsDetails.mock() {
    return InstagramViewsDetails(
      totalViews: 0,
      accountsReached: 0,
      reelsPercentage: 0,
...
class InstagramInteractionsDetails {
  ...
  factory InstagramInteractionsDetails.mock() {
    return InstagramInteractionsDetails(
      totalInteractions: 0,
      likes: 0,
      comments: 0,
...
class InstagramFollowersDetails {
  ...
  factory InstagramFollowersDetails.mock() {
    return InstagramFollowersDetails(
      totalFollowers: 0,
